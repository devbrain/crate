...
// Hardcoded reference data: expected {file_count, total_size, combined_crc32}
// Generated by extracting each archive with unrar and computing CRC32 over
// all regular (non-symlink) files sorted by relative path.
struct ExpectedRef {
    size_t file_count;
    size_t total_size;
    u32 combined_crc32;
...
const std::map<std::string, ExpectedRef> REFERENCE_DATA = {
    {"01", {3, 301767, 0x0B6B40DFU}},
    {"02", {3, 301767, 0x0B6B40DFU}},
    {"03", {4, 374613, 0xB62E9CC9U}},
    {"06", {3, 301767, 0x0B6B40DFU}},
    {"07", {3, 301767, 0x0B6B40DFU}},
    {"08", {1, 143984, 0xA5E4C86CU}},
    {"09", {1, 143984, 0xA5E4C86CU}},
    {"10", {1, 143984, 0xA5E4C86CU}},
    {"11", {1, 72846, 0x61D95912U}},
    {"12", {1, 72846, 0x61D95912U}},
    {"13", {2, 157783, 0xA809B825U}},
    {"14", {9, 893210, 0x62074975U}},
    {"15", {1, 143984, 0xA5E4C86CU}},
    {"16", {1, 143984, 0xA5E4C86CU}},
    {"20", {1, 72846, 0x61D95912U}},
    {"21", {2, 157783, 0xA809B825U}},
    {"23", {6, 301806, 0x28086D99U}},
    {"28", {1, 72846, 0x61D95912U}},
    {"29", {2, 145692, 0xF9C4DCE5U}},
    {"33", {1, 72846, 0x61D95912U}},
    {"34", {1, 72846, 0x61D95912U}},
    {"35", {2, 157783, 0xA809B825U}},
    {"47", {2, 72859, 0x37A442E6U}},
    // Symlink archives (includes symlink entries whose content is the target path)
    {"18", {6, 301806, 0x28086D99U}},
    {"24", {2, 72866, 0x2EE88D45U}},
    {"27", {2, 145692, 0xF9C4DCE5U}},
    {"30", {2, 72859, 0x37A442E6U}},
    {"31", {2, 72862, 0xBDF9FB3AU}},
    // WinRAR link archives (regular files only)
    {"37", {2, 145692, 0xF9C4DCE5U}},
    {"38", {1, 72846, 0x61D95912U}},
    {"40", {1, 72846, 0x61D95912U}},
    {"42", {1, 72846, 0x61D95912U}},
    {"44", {2, 145692, 0xF9C4DCE5U}},
    {"45", {1, 72846, 0x61D95912U}},
    // SFX archives
    {"54", {1, 72846, 0x61D95912U}},
    {"55", {1, 72846, 0x61D95912U}},
    {"56", {1, 72846, 0x61D95912U}},
};
...
// Compute combined CRC32 over all extracted files (sorted by name)
u32 combined_crc32(const std::map<std::string, byte_vector>& files) {
    crc_32 crc;
...
void verify_extraction(rar_archive& archive, const std::string& test_id) {
    ...
    CHECK(combined_crc32(extracted) == ref.combined_crc32);
}
...
TEST_SUITE("RarArchive - Corpus Summary") {
    ...
    TEST_CASE("Full extraction test - all basic RAR5 archives") {
        ...
        for (const auto& test_id : basic_tests) {
            ...
            auto extracted = extract_with_crate(**archive);
            u32 crc = combined_crc32(extracted);

            if (extracted.size() == ref.file_count && crc == ref.combined_crc32) {
                passed++;
            } else {
                failures.push_back("Test " + test_id + ": CRC mismatch or file count mismatch");
                failed++;
            }
        }
